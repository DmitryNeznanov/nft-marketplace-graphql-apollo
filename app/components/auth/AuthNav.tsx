...
export default function AuthNav({
  ...
  return (
    <div className="relative">
      <button
        className="p-[12px] flex items-center justify-center rounded-full bg-black-white hover:cursor-pointer"
        onClick={() => toggleMenu()}
      >
        <Image
          className="block"
      ...
      {open && (
        <div
          className="min-w-[120px] mt-[5px] -ml-[44px] absolute z-50 bg-black-white border-[2px] border-accent rounded-[10px] overflow-hidden"
          ref={menuRef}
        >
          <Link
