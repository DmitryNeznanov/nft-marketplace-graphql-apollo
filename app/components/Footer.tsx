          ...
          <section className="xl:w-auto mx-auto md:mx-0 lg:px-[30px] flex flex-col xl:flex-row xl:justify-between gap-y-[30px]">
            <section>
              <article>
                ...
                <p className="max-w-[240px] md:max-w-max xl:max-w-[240px] mt-[20px] md:mt-[30px] font-work-sans text-[#ccc]">
                  NFT marketplace UI created with Anima for Figma.
                </p>
              </article>
              <div className="mt-[20px]">
                <p className="font-work-sans text-[#ccc]">Join our community</p>
            ...
            <section>
              ...
              <ul className="mt-[20px] md:mt-[25px] flex flex-col gap-y-[20px]">
                {[
                  ...
                  return (
                    <li
                      className="w-max font-work-sans text-[#ccc]"
                      key={i}
                    >
                      <Link
