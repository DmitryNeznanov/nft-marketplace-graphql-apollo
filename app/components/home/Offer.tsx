          ...
          <article className="flex flex-col gap-[30px] md:flex-row justify-between">
            <div className="contents md:flex flex-col gap-[30px]">
              ...
              <div className="order-4 md:order-3">
                <Link
                  className="w-full md:w-max button-white"
                  href="#"
                >
                  see NFT
                </Link>
            ...
            <div className="w-full h-max md:w-max p-[30px] flex flex-col items-center md:items-start self-end rounded-[20px] bg-black-white/50 overflow-hidden order-3 md:order-3">
